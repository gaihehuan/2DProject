...
public class FuelTank : MonoBehaviour {
	...
	void Start(){
		...
		ConfigurableJoint join = fuelTank.GetComponent<ConfigurableJoint>();
		if (join == null){
			join = fuelTank.gameObject.AddComponent<ConfigurableJoint>();
			...
			join.angularZMotion=ConfigurableJointMotion.Locked;
		}
